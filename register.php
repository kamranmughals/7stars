        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="register-form">
                    <div id="danger-box" style="display:none;" class="alert alert-danger" role="alert">
                        Error while registration! Please check if all the information is correct and try again.
                    </div>
                    <div id="msg-box"></div>
                    <h2>Register</h2>
